...
struct RotatingCard: View {
    ...
    var body: some View {
        ...
        return VStack {
            Spacer()
            Image(flipped ? "Larry" : images[imgIndex]).resizable().scaledToFill()
                .frame(width: 212, height: 320).clipped()
                .modifier(FlipEffect(flipped: binding, angle: animate3d ? 360 : 0, axis: (x: 1, y: 0)))
...
struct AnimationExamples_Previews: PreviewProvider {
